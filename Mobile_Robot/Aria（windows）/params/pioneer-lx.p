...
SonarBoardPort COM9      ; Port the sonar is on.
...
LaserPort COM4           ; Port the laser is on.
...
BatteryPort COM8         ; Port the battery is on.
...
LCDPort COM3             ; Port that the LCD is on.
